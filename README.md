...
- 액세스 토큰이 만료되면 자동으로 토큰이 갱신됩니다.

### 관리자 관리

**슈퍼 관리자 계정 등록**

- 아이디, 이메일, 연락처, 이름, 비밀번호를 입력하여 슈퍼 관리자 계정을 생성합니다.

**관리자 계정 등록**

- 아이디, 이메일, 연락처, 이름, 비밀번호, 아파트 정보를 입력하여 관리자 계정을 생성합니다.

**관리자 계정 가입 상태 변경**

- 슈퍼 관리자 권한으로 관리자 계정의 가입 상태를 단건 또는 다건으로 변경할 수 있습니다.

**관리자 계정 목록 조회**

- 슈퍼 관리자 권한으로 관리자 계정 목록을 조회할 수 있습니다.

**관리자 계정 삭제**

- 슈퍼 관리자 권한으로 관리자 계정을 삭제할 수 있습니다.

### 아파트 관리

**아파트 조회**

- 아파트 목록 조회 및 아파트 상세 조회가 가능합니다.

### 알림

- SSE(Server-Sent Events)를 이용해 실시간 알림을 수신할 수 있으며 알림 목록 조회 및 읽음 처리가 가능합니다.

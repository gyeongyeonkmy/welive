...
import {
  AdminAccountEntity,
  AdminAccountProps,
} from '../../application/command/entities/user/admin-account-entity';
import { Prisma } from '@prisma/client';
import {
  ResidentAccountEntity,
  ResidentAccountProps,
} from '../../application/command/entities/user/resident-account-entity';
import {
  NotJoinedResidentEntity,
  NotJoinedResidentProps,
} from '../../application/command/entities/user/not-joined-resident-entity';

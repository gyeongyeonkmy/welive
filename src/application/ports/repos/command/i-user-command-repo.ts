import { AdminAccountProps } from '../../../command/entities/user/admin-account-entity';
import { BaseUserProps } from '../../../command/entities/user/base-user-entity';
import { NotJoinedResidentProps } from '../../../command/entities/user/not-joined-resident-entity';
import { ResidentAccountProps } from '../../../command/entities/user/resident-account-entity';
